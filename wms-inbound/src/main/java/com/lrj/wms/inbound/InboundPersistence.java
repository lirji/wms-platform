...
class InboundPersistence {
    ...
    HikariDataSource dataSource(InboundDatasourceProperties properties, DatabaseBudget budget) {
        return RuntimeDataSources.create("inbound", properties.url(), properties.username(), properties.password(), budget);
    }
