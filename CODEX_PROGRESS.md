...
按已批准计划把整个 WMS v1 做到 S9 与 50 项 AC。切片完成后自动下一片，不要等「继续」。当前切片 S6-03 本地已通过。等待 S5-06 main CI 后按序发布 S6-01、S6-01a、S6-02、S6-03。未发明 OQ-03。未到计划 S8 前不创建 `wms-console/`。
