...
class InventoryPersistence {
    ...
    static SqlSessionFactory sessions(DataSource dataSource, TransactionFactory transactions, DatabaseBudget budget) {
        ...
        config.addMapper(com.lrj.wms.inventory.serial.SerialTransferCommandMapper.class);
        ...
        config.addMapper(com.lrj.wms.inventory.serial.SerialOutboundMapper.class);
        config.addMapper(com.lrj.wms.inventory.serial.SerialShipmentMapper.class);
        ...
        config.addMapper(com.lrj.wms.inventory.recon.ReconciliationCollectionMapper.class);
