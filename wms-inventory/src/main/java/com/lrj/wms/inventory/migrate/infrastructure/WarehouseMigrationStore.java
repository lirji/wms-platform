...
public final class WarehouseMigrationStore {
    ...
    public static final List<String> COPY_TABLES = List.of("warehouse", "location", "location_gate", "lot", "stock_balance",
            ...
            "archive_plan", "archive_plan_item", "serial_recovery_intent", "serial_recovery_audit", "inventory_tcc_intent", "serial_receipt_batch", "serial_release_intent", "count_adjustment_intent", "count_serial_intent", "serial_pick_fact", "serial_shipment_intent", "reconciliation_history_guard", "reconciliation_collection_audit");
