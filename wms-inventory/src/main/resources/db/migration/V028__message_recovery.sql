...
ALTER TABLE outbox_event ADD COLUMN retry_base_epoch BIGINT NOT NULL DEFAULT 0 COMMENT '最近获授权重试的代际基线，不改变claim_epoch';
...
CREATE INDEX idx_message_recovery_page ON outbox_event (enterprise_id, warehouse_id, status, event_id);
