...
-- Seata 2.6.0 storeMode=db 本地 TC 会话表。不是生产 TC，也不是 Testcontainers 探针库。
-- 表结构与隔离探针 V001 同源；此处供 compose 空库首次初始化。
USE seata;
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT = 'Seata 2.6.0 本地TC会话存储';
