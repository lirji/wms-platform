...
class SourceWindowDigestTest {
    @Test void versionOneDigestHasStableCrossLanguageVector() {
        ...
        assertEquals("f6b25c07e72abb0afbc96fc2433aa2ec6806bf3e956e67655fc208bac1938411",SourceWindowService.append(initial,
                new SourceWindowService.Fact("CMD","SHIP","EX","1","1","POST","2026-09-12T00:00:00Z")));
    }
}
